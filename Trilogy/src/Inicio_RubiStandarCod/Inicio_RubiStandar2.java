...
/**
 * En la página de Inicio Rubí Standar 2 podrás consumir contenido audiovisual de películas y con un botón de recarga cambiará el contenido audiovisual.
...
public class Inicio_RubiStandar2 extends JFrame {
	...
	// ----------------------------------------------------------------------------------------
	/**
	 * En el método main ejecutamos la ventana principal Inicio Rubí Standar 2
	 */
	...
	// ----------------------------------------------------------------------------------------
	/**
	 * En el constructor Inicio_RubiStandar2() están todos los atributos y métodos necesarios para cuando creemos el objeto tenga todas las funcionalidades.
	 */
	public Inicio_RubiStandar2() {
		...
		btn_Recarga1.addMouseListener(new MouseAdapter() {
			...
			//CUANDO EL RATÓN NO ESTÁ ENCIMA
			@Override
