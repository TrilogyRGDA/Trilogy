...
/**
 * En la página de Inicio Cristal Basic podrás consumir contenido audiovisual de música y con dos botónes de recarga cambiarán el contenido audiovisual respectivo a la selección.
 ...
 */
public class Cristal_Basic extends JFrame {
	/**
	 * Es la versión número 1 de la página de la membresía Cristal Basic.
	 */
	...
	// ----------------------------------------------------------------------------------------
	/**
	 * En el método main ejecutamos la ventana principal Cristal_Basic.
	 */
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Cristal_Basic frame = new Cristal_Basic();
	...
	// ----------------------------------------------------------------------------------------
	/**
	 * En el constructor Cristal_Basic() están todos los atributos y métodos necesarios para cuando creemos el objeto tenga todas las funcionalidades.
	 */
	public Cristal_Basic() {
		// ----------------------------------------------------------------------------------------
		...
		Panel_CristalBasic.setBounds(0, 0, 961, 664);
		...
		// ----------------------------------------------------------------------------------------
		// ----------------------------------------------------------------------------------------
		//lbl_CancionesMasEscuchadas TIENE EL TÍTULO DE LA CATEGORÍA DE LAS CANCIONES QUE SE VAN A REPRODUCIR
		// ----------------------------------------------------------------------------------------
		...
		lbl_CancionesMasEscuchadas.setBounds(180, 51, 674, 30);
		// ----------------------------------------------------------------------------------------
		//lbl_Albumes TIENE EL TÍTULO DE LA CATEGORÍA DE LOS ÁLBUMES QUE SE VAN A REPRODUCIR.
		// ----------------------------------------------------------------------------------------
		...
		lbl_Albumes.setBounds(180, 345, 674, 30);
		// ----------------------------------------------------------------------------------------
		// ÁLBUMES
		// ----------------------------------------------------------------------------------------
		// ----------------------------------------------------------------------------------------
		...
		lbl_IMGAlbum5.setBounds(767, 403, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		lbl_IMGAlbum5.setIcon(CatalogoAudiovisual.obtenerImagenAlbum(4,lbl_IMGAlbum5.getWidth(),lbl_IMGAlbum5.getHeight()));
		// ----------------------------------------------------------------------------------------
		...
		lbl_IMGAlbum4.setBounds(605, 403, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		lbl_IMGAlbum4.setIcon(CatalogoAudiovisual.obtenerImagenAlbum(3,lbl_IMGAlbum4.getWidth(),lbl_IMGAlbum4.getHeight()));
		// ----------------------------------------------------------------------------------------
		...
		lbl_IMGAlbum3.setBounds(443, 403, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		lbl_IMGAlbum3.setIcon(CatalogoAudiovisual.obtenerImagenAlbum(2,lbl_IMGAlbum3.getWidth(),lbl_IMGAlbum3.getHeight()));
		// ----------------------------------------------------------------------------------------
		...
		lbl_IMGAlbum2.setBounds(280, 403, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		lbl_IMGAlbum2.setIcon(CatalogoAudiovisual.obtenerImagenAlbum(1,lbl_IMGAlbum2.getWidth(),lbl_IMGAlbum2.getHeight()));
		// ----------------------------------------------------------------------------------------
		...
		lbl_IMGAlbum1.setBounds(104, 403, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		lbl_IMGAlbum1.setIcon(CatalogoAudiovisual.obtenerImagenAlbum(0,lbl_IMGAlbum1.getWidth(),lbl_IMGAlbum1.getHeight()));
		// ----------------------------------------------------------------------------------------
		// CANCIONES
		// ----------------------------------------------------------------------------------------
		// ----------------------------------------------------------------------------------------
		...
		lbl_IMGCancion5.setBounds(767, 111, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		...
		lbl_IMGCancion4.setBounds(605, 111, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		...
		lbl_IMGCancion3.setBounds(443, 111, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		...
		lbl_IMGCancion2.setBounds(280, 111, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		...
		lbl_IMGCancion1.setBounds(104, 111, 142, 136);
		// AJUSTAR IMAGEN AL CONTENIDO
		...
		btn_Recarga_Canciones2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(contador1_2==1) {
					...
					lblTextoAlbum1.setVisible(false);
					CatalogoAudiovisual.obtenerTextoAlbum(num_album, lblTextoAlbum1);	
					lblTextoAlbum1.setVisible(true);
					...
					lblTextoAlbum2.setVisible(false);
					CatalogoAudiovisual.obtenerTextoAlbum(num_album, lblTextoAlbum2);	
					lblTextoAlbum2.setVisible(true);
					...
					lblTextoAlbum3.setVisible(false);
					CatalogoAudiovisual.obtenerTextoAlbum(num_album, lblTextoAlbum3);	
					lblTextoAlbum3.setVisible(true);
					...
					lblTextoAlbum4.setVisible(false);
					CatalogoAudiovisual.obtenerTextoAlbum(num_album, lblTextoAlbum4);	
					lblTextoAlbum4.setVisible(true);
					...
					lblTextoAlbum5.setVisible(false);
					CatalogoAudiovisual.obtenerTextoAlbum(num_album, lblTextoAlbum5);	
					lblTextoAlbum5.setVisible(true);
		...
		btn_Recarga_Canciones2.setContentAreaFilled(false);
		btn_Recarga_Canciones2.setBounds(44, 448, 50, 50);
		// AJUSTAR IMAGEN AL CONTENIDO
		...
		btn_Recarga_Canciones.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(contador1_1==1) {
					...
					lblTextoCancion1.setVisible(false);
					CatalogoAudiovisual.obtenerTextoCancion(num_cancion, lblTextoCancion1);	
					lblTextoCancion1.setVisible(true);
					num_cancion++;
					//2
					...
					lblTextoCancion2.setVisible(false);
					CatalogoAudiovisual.obtenerTextoCancion(num_cancion, lblTextoCancion2);	
					lblTextoCancion2.setVisible(true);
					num_cancion++;
					//3
					...
					lblTextoCancion3.setVisible(false);
					CatalogoAudiovisual.obtenerTextoCancion(num_cancion, lblTextoCancion3);	
					lblTextoCancion3.setVisible(true);
					num_cancion++;
					//4
					...
					lblTextoCancion4.setVisible(false);
					CatalogoAudiovisual.obtenerTextoCancion(num_cancion, lblTextoCancion4);	
					lblTextoCancion4.setVisible(true);
					num_cancion++;
					//5
					...
					lblTextoCancion5.setVisible(false);
					CatalogoAudiovisual.obtenerTextoCancion(num_cancion, lblTextoCancion5);	
					lblTextoCancion5.setVisible(true);
					num_cancion++;
				}
		...
		btn_Recarga_Canciones.setContentAreaFilled(false);
		btn_Recarga_Canciones.setBounds(44, 156, 50, 50);
		// AJUSTAR IMAGEN AL CONTENIDO
		...
		lblTextoAlbum3.setBounds(443, 550, 142, 27);
		// ----------------------------------------------------------------------------------------
		...
		lblTextoAlbum2.setBounds(267, 550, 166, 27);
		// ----------------------------------------------------------------------------------------
		//lblTextoAlbum1 TIENE EL TEXTO DEL NOMBRE DEL ÁLBUM QUE SE VA A REPRODUCIR.
		// ----------------------------------------------------------------------------------------
		...
		lblTextoAlbum1.setBounds(57, 550, 208, 27);
		// ----------------------------------------------------------------------------------------
		...
		lblTextoCancion5.setBounds(735, 258, 216, 27);
		// ----------------------------------------------------------------------------------------
		...
		lblTextoCancion4.setBounds(605, 258, 142, 27);
		// ----------------------------------------------------------------------------------------
		...
		lblTextoCancion3.setBounds(443, 258, 142, 27);
		// ----------------------------------------------------------------------------------------
		...
		lblTextoCancion2.setBounds(280, 258, 142, 30);
		// ----------------------------------------------------------------------------------------
		...
		lblTextoCancion1.setBounds(104, 258, 142, 27);
		// ----------------------------------------------------------------------------------------
		...
		lblFondo_Cristal.setBounds(0, 0, 961, 664);
